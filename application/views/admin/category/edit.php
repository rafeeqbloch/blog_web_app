                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <div class="card-title">
                            Edit Selected  Category  <strong><?php echo $category['name']?></strong>
                        </div>

                    </div>
                    <form method="post" action="<?php echo base_url() . 'admin/category/edit/'.$category['id']; ?>" id="categoryForm" name="categoryForm" class="categoryForm"  enctype="multipart/form-data">

                        <div class="card-body">
                            <div class="form-group">
                                <label for="name">Name</label>
                                <input type="text" id="name" value="<?php echo set_value('name',$category['name']);?> " name="name"  class="form-control 
                                
                                <?php echo (form_error('name') != "") ? "is-invalid" : '' ?>">
                            ...
                            <div class="form-group">
                                ...
                                <?php if($category['image']!=" " && file_exists('./public/uploads/category/thumb/' . $category['image']) ) { ?>
                                    <img src="<?php echo base_url().'public/uploads/category/thumb/'.$category['image']; ?>" width="200px" class="mt-2" alt="">
                                    <?php }else{ ?>
                                        <img src="<?php echo base_url().'public/uploads/category/no_image.jpg'; ?>" width="200px" alt="">
                                    <?php }?>
                            </div>
